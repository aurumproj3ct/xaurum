...
unsigned int nStakeMinAge = 30 * 60; // 30min
unsigned int nStakeMaxAge = 24 * 60 * 60; // 1 days
...
const string strMessageMagic = "Xaurum Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Xaurum", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = " ... sic manet gloria mundi. ";
        CTransaction txNew;
        txNew.nTime = 1423533722;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1423533722;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2145833;
		if(fTestNet)
        {
            block.nNonce   = 145890;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xabe132b2d1d625f7cd041a9fb2a7b67612b40b10b56b71854dd9cfe58691eda8"));
        block.print();
